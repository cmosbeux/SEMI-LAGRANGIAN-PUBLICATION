...
#MSUB -r TH_advection
#MSUB -e LOG/TH_advection.e%j
#MSUB -o LOG/TH_advection.o%j
#MSUB -n 8
#MSUB -T 600
#MSUB -A gen6066
#MSUB -q rome
...
. ./TH_advection.sh parallel 2 1 1 TEST1
. ./TH_advection.sh parallel 2 0.5 1 TEST1
. ./TH_advection.sh parallel 2 0.25 1 TEST1
. ./TH_advection.sh parallel 2 0.1 1 TEST1
. ./TH_advection.sh parallel 2 0.01 1 TEST1
